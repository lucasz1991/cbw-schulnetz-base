    ...
    <div data-simplebar class="h-full">
        ...
        <div class="metismenu pb-10 pt-2.5" id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="{{ route('tutor.contact') }}" class="block py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-blue-500  space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#545a6d33" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.82 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
                        <span data-key="t-helpcontact">Hilfe & Kontakt</span>
                    </a>
                </li>
