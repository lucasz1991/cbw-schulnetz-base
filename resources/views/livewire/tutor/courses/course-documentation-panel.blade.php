<div x-data="{ showSelectDayCalendar: $persist(false).as('showSelectDayCalendar_documentation') }">
  @if($course->dates->count() > 0)
    <div class="flex space-x-8">
      <div class="mt-6 w-full transition-all duration-600 ease-in-out"
           :class="{ ' md:w-2/3 xl:w-4/5 ': showSelectDayCalendar }">
        @if($selectedDayId)
      ...
      <div class="hidden md:block w-full mt-2"
           :class="{ 'md:w-1/3 xl:w-1/5': showSelectDayCalendar }"
