<footer x-data="{ screenWidth: window.innerWidth }" x-resize="screenWidth = $width" style="background-image:url({{ asset('/site-images/bg_footer.jpg') }});"; class="footer bg-cover bg-center border-t border-gray-300  bg-white  ">
    <div class="bg-white/30 backdrop-brightness-130 tracking-wide px-8 py-12 ">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false" >
                        <ul class="space-y-5 mt-6">
                            <li>
                            <a href="/aboutus" wire:navigate  class='hover:text-gray-400 text-gray-700 text-sm'>Über uns</a>
                            </li>
                            <li>
                            <a  href="/howto" wire:navigate  class='hover:text-gray-400 text-gray-700 text-sm'>So funktionierts</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div x-data="{ open: false }" x-intersect.full.once="setTimeout(() => {open = true;}, 1000);">
                    <h4 class="text-gray-400 font-semibold text-lg relative max-sm:cursor-pointer" @click="open = !open">Additional 
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false"  >
                        <ul class="space-y-5 mt-6 ">
                            ...
                            <li>
                            <a  href="/contact" wire:navigate  class='hover:text-gray-400 text-gray-700 text-sm'>Kontakt</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div>
                    <ul class="md:flex md:space-x-6 max-md:space-y-2 max-sm:grid max-sm:grid-flow-row-dense max-sm:grid-cols-3 max-sm:grid-rows-3">
                        <li class="max-sm:col-span-2">
                            <a href="/termsandconditions" wire:navigate class='hover:text-gray-400 text-gray-700 text-sm '>AGB's</a>
                        </li>
                        <li class="max-sm:col-span-2">
                            <a href="/privacypolicy" wire:navigate class='hover:text-gray-400 text-gray-700 text-sm '>Datenschutz</a>
                        </li>
                        <li class="max-sm:col-span-2">
                            <a href="/imprint" wire:navigate class='hover:text-gray-400 text-gray-700 text-sm '>Impressum</a>
                        </li>
                        <li class="max-sm:inline-flex max-sm:place-self-end max-sm:w-max" >
                            <a class=""  href='' target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-primary hover:fill-secondary w-7 h-7"
                                viewBox="0 0 24 24">
                        ...
                        <li class="max-sm:inline-flex max-sm:place-self-end max-sm:w-max" >
                            <a class="" href='' target="_blank">
                                ...
                                class="fill-primary hover:fill-secondary w-7 h-7" viewBox="0 0 24 24">
                                <path
