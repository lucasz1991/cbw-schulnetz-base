...
<head>
    <meta charset="utf-8">
    <title>Anmeldung zur Prüfung</title>
    <style>
        @page {
...
<table class="meta-table">
    ...
    <tr>
        <td class="meta-label">Prüfungsfach</td>
        <td class="meta-value">
            {{ $request->exam_subject ?? '—' }}
        </td>
    </tr>
    <tr>
        <td class="meta-label">Gewünschter Prüfungstermin</td>
        <td class="meta-value">
            @if(!empty($request->exam_date))
...
<div class="text-block">
    Hiermit beantrage ich die Teilnahme an der oben genannten Prüfung.
    Mir ist bekannt, dass die Prüfungsmodalitäten (Zulassungsvoraussetzungen,
    Fristen, Bewertung und Wiederholungsmöglichkeiten) gemäß den jeweils
    gültigen Regelungen des Trägers und der Prüfungsordnung gelten.
</div>
